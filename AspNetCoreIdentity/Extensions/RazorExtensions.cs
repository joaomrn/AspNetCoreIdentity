...
namespace AspNetCoreIdentity.Extensions
{
    public static class RazorExtensions
    {
        ...
        public static IHtmlContent IfClaimShow(this IHtmlContent page, HttpContext contex, string claimName, string claimValue)
        {
            return CustomAuthorization.ValidarClaimsUsuario(contex, claimName, claimValue) ? page : null;
        }
    }
}
